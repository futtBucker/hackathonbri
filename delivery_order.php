    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Order Pengiriman</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                                ...
                                <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-6">
                                                    ...
                                                    <select id="vensel" name="vensel" class="selectpicker" data-live-search="true">
                                                        <option data-tokens="CV. ABC">CV. ABC</option>
                                                        <option data-tokens="CV. DEF">CV. DEF</option>
                                                        <option data-tokens="CV. GHI">CV. GHI</option>
                                                    </select>
                                                </div>
                                                <div class="col-lg-6">
                                                    <label>&nbsp;</label>
                                    ...
                                    <div class="col-lg-6">
                                        <form role="form">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <div class="col-lg-12">
                                                        <label for="disabledSelect">Terima Via :</label>
                                                        <input class="form-control">
                                                    </div>  
                                                </div>
                                        </form>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <!--</div><div class="col-sm-2"> <h3>Sub Total :</h3> </div>-->
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <!--                                                <label>Keterangan :</label>
